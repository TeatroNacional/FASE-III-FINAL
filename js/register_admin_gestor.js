...
function validateFields() {
  ...
  }else if(!validate_field(role)){
    showMessage('The role field is empty, Please you must enter the role',"info"); return false;
  }
...
function register () {
  ...
  .then(function() {
    ...
    // DOne
    showMessage("Employee" + name + "credentials have been successfully");
